const english = {
  en: {
    translation: {
      ...
      "Delete from fridge": "Delete from cupboard",
      Continue: "Continue",
...
these recipes.`,
      ...
      "Scan food items to add to your fridge":
        "Scan food items to add to your cupboard",
      "See a list of groceries in your fridge ordered by expiration date":
        "See a list of groceries in your cupboard ordered by expiration date",
      Foodbanks: "Foodbanks",
      ...
      "Show onboarding screen again": "Show onboarding screen again",
